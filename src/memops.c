...
{
    AssertMsg(src_skip == 4, "src_skip does not support non-interleaved yet (%d != 4)", src_skip);
    while (frames--)
    {
...
{
    AssertMsg(dst_skip == 4, "dst_skip does not support non-interleaved yet (%d != 4)", dst_skip);
